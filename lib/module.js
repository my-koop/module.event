...
var Module = (function (_super) {
    ...
    Module.prototype.getEvents = function (data, callback) {
        ...
        this.db.getConnection(function (err, connection, cleanup) {
            ...
            var query = connection.query("SELECT e.idEvent, e.type, e.startDate, e.endDate, e.startAmount, e.endAmount, name, count(eu.idEvent) as countRegistered " + "FROM event e LEFT JOIN event_user eu ON eu.idEvent = e.idEvent WHERE e.endDate IS " + isNull + " NULL GROUP BY e.idEvent", [], function (err, rows) {
                cleanup();
                if (err) {
                    return callback(new DatabaseError(err));
                }
