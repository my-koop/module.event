...
function attachControllers(binder) {
    ...
    binder.attach({ endPoint: endPoints.event.unregister }, binder.makeSimpleController(event.unregisterToEvent, function (req) {
        return {
            idUser: parseInt(req.param("idUser")),
            idEvent: parseInt(req.param("idEvent"))
        };
    ...
    binder.attach({ endPoint: endPoints.event.notes.new }, core.newNoteController.bind(core, "event_notes"));
    binder.attach({ endPoint: endPoints.event.notes.list }, core.getNotesController.bind(core, "event_notes"));
}
