...
function attachControllers(binder) {
    ...
    binder.attach({ endPoint: endPoints.event.start }, startEvent);
    binder.attach({ endPoint: endPoints.event.end }, endEvent);
    binder.attach({ endPoint: endPoints.event.end }, binder.makeSimpleController("endEvent", {
